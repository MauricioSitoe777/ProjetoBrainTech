...
const WORDS: { text: string; color: string }[] = [
  { text: "Alugue",   color: "#d8a020" }, // amber-500 (brand gold)
  { text: "Compre",   color: "#f0c840" }, // amber-300
  { text: "SUVs",     color: "#e8b830" }, // amber-400
  { text: "Pick-ups", color: "#d8a020" }, // amber-500
  { text: "Sedans",   color: "#f0c840" }, // amber-300
];
...
function ShufflingCards() {
  ...
  // usa o último slot para que o cálculo funcione com qualquer nº de colunas
...
export default function Hero({ onShowSimulator }: { onShowSimulator?: () => void }) {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Overlay escuro — mantém legibilidade sobre o vídeo */}
      <div
