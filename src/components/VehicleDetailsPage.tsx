  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans antialiased">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <button
          onClick={onExit}
          className="flex items-center gap-2 text-white hover:text-amber-500 transition-colors mb-8 group"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              ...
              <div className="flex flex-wrap items-center gap-4 text-white text-[11px] font-bold uppercase tracking-widest">
            ...
            <div className="bg-zinc-900/40 border border-zinc-800/60 rounded-3xl p-6 mb-6">
              <div className="flex flex-col gap-4 mb-6">
                <div>
                  <p className="text-white text-[10px] uppercase font-black tracking-widest mb-1">Preço Sugerido</p>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-white text-[10px] uppercase font-black tracking-widest">Preço Final</p>
            ...
            <div className="mt-auto flex flex-col gap-3">
              ...
              <button className="w-full py-4 rounded-2xl border border-zinc-800 bg-zinc-900/50 text-white font-bold uppercase text-[10px] tracking-widest hover:bg-zinc-800 transition-all flex items-center justify-center gap-2">
