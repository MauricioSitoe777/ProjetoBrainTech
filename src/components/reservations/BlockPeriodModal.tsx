    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            <label className="block text-xs text-white mb-1">Viatura</label>
            <select
              value={vehicleId}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs text-white mb-1">Início</label>
            ...
            <div>
              <label className="block text-xs text-white mb-1">Fim</label>
          ...
          <div>
            <label className="block text-xs text-white mb-1">Motivo</label>
