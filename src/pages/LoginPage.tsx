      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        {onCancel && (
          <button
            ...
            className="absolute top-0 right-0 sm:-right-4 w-10 h-10 rounded-full border border-zinc-800 bg-zinc-900/60 text-white hover:text-white hover:border-zinc-700 hover:bg-zinc-800/80 transition-all active:scale-95 flex items-center justify-center cursor-pointer shadow-lg"
          >
        ...
        <div className="flex bg-zinc-900/50 p-1 rounded-2xl border border-zinc-800 mb-6 max-w-[300px] mx-auto">
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-xs font-bold transition-all ${!isRegister ? 'bg-amber-400 text-zinc-950 shadow-lg' : 'text-white hover:text-white'}`}
          >
            Entrar
          </button>
          <button
              ...
              {filteredAccounts.map(acc => (
                <button
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl border transition-all ${
                    ...
                    : 'bg-zinc-900/40 border-zinc-800/50 text-white hover:border-zinc-700 hover:text-white'
                  }`}
                >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {isRegister && (
              <div className="space-y-1.5">
                <label className="text-[13px] font-medium text-white ml-1">Nome Completo</label>
            ...
            {isRegister && (
              <div className="space-y-1.5">
                <label className="text-[13px] font-medium text-white ml-1">Tipo de Funcionário</label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-white">
            ...
            <div className="space-y-1.5">
              ...
              {isRegister && (
                <p className="text-[10px] text-white mt-1 ml-1 italic">Dica: Utilize '123' para facilitar o teste neste demo.</p>
              )}
            </div>
